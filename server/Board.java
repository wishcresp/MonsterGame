...
public class Board
{
	...
	public void build_board_graph()
	{
		GraphEdge[] edges = {
			    ...
			    */  
			      new GraphEdge(0, 2, 1), new GraphEdge(0, 3, 1), new GraphEdge(0, 4, 1),
			      new GraphEdge(0, 1, 1), new GraphEdge(1, 3, 1), new GraphEdge(1, 4, 1),
			      new GraphEdge(1, 5, 1), new GraphEdge(2, 4, 1), new GraphEdge(3, 5, 1),
			      new GraphEdge(4, 5, 1), new GraphEdge(4, 6, 1), new GraphEdge(4, 7, 1),
			      new GraphEdge(5, 6, 1), new GraphEdge(6, 7, 1)
				};	
